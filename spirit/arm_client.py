"""
ARX5 arm connection layer for Spirit VLA local execution.
...
class ARX5ArmClient:
    """
    ARX5 arm client for Spirit VLA local execution.
    ...
    def execute_actions(self, actions: list, duration: float) -> None:
        ...
        # print(f"positions: {self.now_state}")
        # print("111111111111")
